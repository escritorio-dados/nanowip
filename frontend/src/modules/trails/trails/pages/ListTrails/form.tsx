...
import { ITrailFilters } from '#modules/trails/trails/types/ITrail';

export const defaultTrailFilter: ITrailFilters = {
  name: '',
  min_updated: null,
  max_updated: null,
};

export function ListTrailsFilter({ apiConfig, ...props }: IListFilter<ITrailFilters>) {
  const {
    handleSubmit,
    control,
    formState: { errors },
    reset: resetForm,
  } = useForm<ITrailFilters>();

  return (
    <FilterListForm
      defaultFilter={defaultTrailFilter}
