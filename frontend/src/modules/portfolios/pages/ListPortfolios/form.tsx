...
import { IPortfolioFilters } from '#modules/portfolios/types/IPortfolio';

export const defaultPortfolioFilter: IPortfolioFilters = {
  name: '',
  min_updated: null,
  max_updated: null,
};

export function ListPortfoliosFilter({ apiConfig, ...props }: IListFilter<IPortfolioFilters>) {
  const {
    handleSubmit,
    control,
    formState: { errors },
    reset: resetForm,
  } = useForm<IPortfolioFilters>();

  return (
    <FilterListForm
      defaultFilter={defaultPortfolioFilter}
