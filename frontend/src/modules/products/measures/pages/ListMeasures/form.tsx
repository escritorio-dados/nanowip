...
import { IMeasureFilters } from '../../types/IMeasure';

export const defaultMeasureFilter: IMeasureFilters = {
  name: '',
  min_updated: null,
  max_updated: null,
};

export function ListMeasuresFilter({ apiConfig, ...props }: IListFilter<IMeasureFilters>) {
  const {
    handleSubmit,
    control,
    formState: { errors },
    reset: resetForm,
  } = useForm<IMeasureFilters>();

  return (
    <FilterListForm
      defaultFilter={defaultMeasureFilter}
