...
import { IProduct, IProductInput, limitedProductLength } from '#shared/types/backend/IProduct';
...
import {
  ...
  updateProductSchema,
} from '#modules/products/schemas/updateProduct.schema';

type IUpdateProductModal = {
  openModal: boolean;
  closeModal(): void;
  product_id: string;
  reloadList: () => void;
    ...
    <>
      ...
      {productData && (
        <CustomDialog
          ...
          title={`Editar projeto - ${productData.name}`}
          maxWidth="md"
        >
