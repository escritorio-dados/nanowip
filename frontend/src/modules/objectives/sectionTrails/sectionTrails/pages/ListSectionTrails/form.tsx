...
import { ISectionTrailFilters } from '../../types/ISectionTrail';

export const defaultSectionTrailFilter: ISectionTrailFilters = {
  name: '',
  min_updated: null,
  max_updated: null,
};

export function ListSectionTrailsFilter({
  apiConfig,
  ...props
}: IListFilter<ISectionTrailFilters>) {
  const {
    handleSubmit,
    control,
    formState: { errors },
    reset: resetForm,
  } = useForm<ISectionTrailFilters>();

  return (
    <FilterListForm
      defaultFilter={defaultSectionTrailFilter}
