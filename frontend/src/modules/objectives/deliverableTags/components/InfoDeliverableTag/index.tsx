...
import { ProgressBar } from '../DeliverableTagCard/ProgressBar';

type IInfoDeliverableTagModal = IBaseModal & { deliverable_id: string };

export function InfoDeliverableTagModal({
  closeModal,
  deliverable_id,
  openModal,
}: IInfoDeliverableTagModal) {
