...
import { IDocumentTypeFilters } from '../../types/IDocumentType';

export const defaultDocumentTypeFilter: IDocumentTypeFilters = {
  name: '',
  min_updated: null,
  max_updated: null,
};

export function ListDocumentTypesFilter({
  apiConfig,
  ...props
}: IListFilter<IDocumentTypeFilters>) {
  const {
    handleSubmit,
    control,
    formState: { errors },
    reset: resetForm,
  } = useForm<IDocumentTypeFilters>();

  return (
    <FilterListForm
      defaultFilter={defaultDocumentTypeFilter}
