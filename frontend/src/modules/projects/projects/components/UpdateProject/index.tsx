...
import {
  ...
  updateProjectSchema,
} from '#modules/projects/projects/schemas/updateProject.schema';
import {
  IProjectType,
...
type IUpdateProjectModal = IReloadModal & { project_id: string };
...
export function UpdateProjectModal({
  ...
  return (
    <>
      ...
      {projectData && (
        <CustomDialog open={openModal} closeModal={closeModal} title="Editar projeto" maxWidth="md">
