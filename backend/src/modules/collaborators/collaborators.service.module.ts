...
import { UsersServiceModule } from '@modules/users/users.service.module';
...
import { FindOneByUserCollaboratorService } from './services/findOneByUser.collaborator.service';
...
@Module({
  ...
  providers: [
    ...
    FindOneByUserCollaboratorService,
