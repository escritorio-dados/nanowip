...
import { IFindByNameProductDto } from '@modules/products/dtos/findByName.product.dto';
import { Product } from '@modules/products/entities/Product';
import { productErrors } from '@modules/products/errors/product.errors';
...
export class CommonProductService {
  ...
  async validateName({ name, product_parent_id, project_id }: IFindByNameProductDto) {
